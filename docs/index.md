...
- Large-signal metrics from Harmonic Balance or transient analysis: output power, gain, and mixing-product isolation.
...
- Large-signal design: **Advanced -> Harmonic Balance** and **Advanced -> Transient Analysis**.
...
- Large-signal goals (`Power_dBm`, `Gain_dB`, `Isolation_dB`) are evaluated on a Harmonic Balance spectrum — or, with a `TRAN:` prefix, on the FFT of a transient analysis — instead of the S-parameter sweep; AC, HB and TRAN goals can be combined in one run.
