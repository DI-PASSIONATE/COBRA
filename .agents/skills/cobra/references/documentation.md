...
| JSON schema and paths | `docs/user-guide/configuration.md` | `src/cobra/configuration.py`, `src/cobra/config_runner.py` |
...
| Fine-tuning | `docs/advanced/fine-tuning.md` | `src/cobra/geometry_loader.py`, `src/cobra/stages/` |
